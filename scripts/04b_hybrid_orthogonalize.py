...
def orthogonalize():
    ...
    print("Loading refusal direction (FROM OFFICIAL PIPELINE)...")
    ...
    print("Applying weight orthogonalization using official vector...")
    modified_layers = 0
    with torch.no_grad():
    ...
    print("Ablation complete. M2 Model saved successfully.")
